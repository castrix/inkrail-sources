const item = { sourceNovelId: 'sample', sourceUrl: 'https://example.invalid/sample', indexUrl: 'https://example.invalid/sample/chapters', titleOriginal: 'Synthetic example — novel', author: 'Inkrail example', description: 'Generated demonstration content for extension developers.', coverUrl: null }
